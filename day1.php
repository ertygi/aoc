...
{
    $expenseRecords = explode(' ', $input);
    $expenseRecords = array_filter($expenseRecords);
    $complements    = [];
    sort($expenseRecords);
